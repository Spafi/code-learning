{
	...
	*/
    ...
    /*
	But if we try to change to the 'const' variable
...

{
    ...
    if (temperature > 15) {
        // if temperature is > 10 ONLY this part will be executed
...

{
    ...
    var usersCount = users.length; // 7, because we have 7 users in the array

    // Each array has also some pre made functions for manipulating the data (adding, removing, updating)
...

{
    ...
    // Ion is 23 years old! His favorite animal is cat, and he likes to eat pizza!
}
// --------------------------------------------------------------

{
    ...
    // To declare a function, we can use
    // The declaration is like a blueprint that says what will happen when we call the function later
    ...
    // When we call a function, it will go to the declaration and figure out what to do
    aFunction();
